            ...
            <DataTable
              ...
              columns={[
                ...
                },
                {
                  ...
                  wrap: true,
                  render: (item) => (
                    <div className="max-w-[165px] whitespace-normal text-sm">
                      <p>{item.nama_ukpd || "-"}</p>
                ...
                { key: "tanggal_usulan", header: "Tgl", width: 112, render: (item) => formatDateTime(item.tanggal_usulan || item.created_at) }
              ]}
              actions={(item) => (
